 ...
 *
 */
@OpenAPIDefinition(info = @Info(title = "Integrator Module MicroServices", version = "1.0.0", description = "API for Integrator Module"), servers = {
		@Server(url = "http://localhost:8080//integrator-api/api") })
